...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject will initialize the resultant variable (first arg of the block) with the argument provided before the block
    # then it will execute the block with the args |result, item| and apply the operation in it and return the resultant
  end
