...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # I really don't understand so I went to stackoberflow and got it ;)
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # we could create a function that doesn't raise errors, causing it
    # to be called every time someone screws up, so it's kind of dangerous
    #
    # NOTE:
    #
